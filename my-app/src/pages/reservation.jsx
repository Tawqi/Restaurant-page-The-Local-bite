    ...
    return (
        ...
        <div className="flex flex-col px-5 gap-6">
            <div className="sec1 flex flex-col gap-3 mt-5">
                <h1 className="text-3xl text-(--primary) font-bold">Reserver Your Table</h1>
            ...
            <form className="flex flex-col gap-5 w-full">
                ...
                <label className="flex flex-col gap-2 md:text-xl">
                  Number of People
                  <input type="number" name="people" placeholder="How many people will attend" min="1" required 
                  className="border bg-(--bg2) md:text-lg border-(--primary) font-thin px-4 py-2 rounded-xl" />
                </label>
            ...
            <img src={tablesImg} className="hidden md:flex w-[50vw] rounded-2xl "></img>
            </div>
